...
func ListClustersColumns() []table.ColumnDefinition {
	return []table.ColumnDefinition{
		...
		table.TextColumn("backtrack_consumed_change_records"),
		table.TextColumn("backtrack_window"),
		...
		// table.TextColumn("db_cluster_members_promotion_tier"),
		...
		// table.TextColumn("earliest_backtrack_time_ext"),
		// table.TextColumn("earliest_backtrack_time_loc"),
		// table.TextColumn("earliest_backtrack_time_loc_cache_end"),
		// table.TextColumn("earliest_backtrack_time_loc_cache_start"),
		...
		// table.TextColumn("earliest_backtrack_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("earliest_backtrack_time_loc_zone_offset"),
		// table.TextColumn("earliest_backtrack_time_wall"),
		table.TextColumn("earliest_restorable_time"),
		// table.TextColumn("earliest_restorable_time_ext"),
		// table.TextColumn("earliest_restorable_time_loc"),
		// table.TextColumn("earliest_restorable_time_loc_cache_end"),
		// table.TextColumn("earliest_restorable_time_loc_cache_start"),
		...
		// table.TextColumn("earliest_restorable_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("earliest_restorable_time_loc_zone_offset"),
		// table.TextColumn("earliest_restorable_time_wall"),
		...
		// table.TextColumn("scaling_configuration_info_max_capacity"),
		// table.TextColumn("scaling_configuration_info_min_capacity"),
		// table.TextColumn("scaling_configuration_info_seconds_until_auto_pause"),
